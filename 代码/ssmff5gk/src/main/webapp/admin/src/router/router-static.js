...
import center from '@/views/center'
    import lisushenqing from '@/views/modules/lisushenqing/list'
    ...
    import sushepingfen from '@/views/modules/sushepingfen/list'
